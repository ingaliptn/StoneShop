...
namespace ASP_pract.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult IndexPost(IEnumerable<Product> ProdList)
        {
            ...
            {
                shoppingCartList.Add(new ShoppingCart { ProductId = prod.Id, SqM = prod.TempSqm });
            }
        ...
        public async Task<IActionResult> SummaryPost(IFormCollection collection, ProductUserVM ProductUserVM)
        {
            ...
            if (User.IsInRole(WC.AdminRole))
            {
                ...
                OrderHeader orderHeader = new OrderHeader()
                {
                    ...
                    FinalOrderTotal = ProductUserVM.ProductList.Sum(x => x.TempSqm * x.Price),
                    City = ProductUserVM.ApplicationUser.City,
                    Address = ProductUserVM.ApplicationUser.Address,
                    State = ProductUserVM.ApplicationUser.State,
                    NP = ProductUserVM.ApplicationUser.NP,
