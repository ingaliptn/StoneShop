...
namespace Rocky.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public IActionResult Upsert(int? id)
        {
            ...
            {
                Product = new Product(),
                CategoryListItem = _prodRepo.GetAllDropdownList(WC.CategoryName),
                AppListListItem = _prodRepo.GetAllDropdownList(WC.ApplicationTypeName),
            };
        ...
        public IActionResult Upsert(ProductVM productVM)
        {
            ...
            productVM.CategoryListItem = _prodRepo.GetAllDropdownList(WC.CategoryName);
            productVM.AppListListItem = _prodRepo.GetAllDropdownList(WC.ApplicationTypeName);
