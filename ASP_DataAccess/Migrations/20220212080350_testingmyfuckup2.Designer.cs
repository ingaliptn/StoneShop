...
namespace ASP_DataAccess.Migrations
{
    ...
    [Migration("20220212080350_testingmyfuckup2")]
    partial class testingmyfuckup2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASP_DataAccess.Data.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ASP_DataAccess.Data.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ASP_DataAccess.Data.OrderDetail", b =>
                {
                    b.HasOne("ASP_DataAccess.Data.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ASP_Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("ASP_DataAccess.Data.OrderHeader", b =>
                {
                    b.HasOne("ASP_Models.ApplicationUser", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("ASP_Models.InquiryDetail", b =>
                {
                    b.HasOne("ASP_Models.InquiryHeader", "InquiryHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("ASP_Models.InquiryHeader", b =>
                {
                    b.HasOne("ASP_Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
